-- ==================================================================
--  صالون صدام — ملف واحد يعمل كل حاجة على Supabase
--
--  طريقة الاستخدام (٣ خطوات بس):
--    1) ادخل supabase.com → مشروعك → SQL Editor → New query
--    2) انسخ الملف ده كله (Ctrl+A ثم Ctrl+C) والزقه هناك
--    3) اضغط RUN  ✅  خلاص كده الجداول والبيانات اتعملت
--
--  (الملف آمن لو شغّلته أكتر من مرة، بس خد بالك: البيانات بتترجع
--   للأصل وأي تعديلات عملتها في الجداول دي هتتمسح)
-- ==================================================================
