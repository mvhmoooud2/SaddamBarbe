...
export default function Hero({ settings }: { settings?: SiteSettingsMap }) {
  return (
    <section
      id="home"
    ...
    >
      <div className="absolute inset-0 z-0">
        <Image
          src={asset(setting(settings, "heroImage"))}
          alt={setting(settings, "siteNameEn")}
          fill
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          >
            ...
            {setting(settings, "heroPrimaryCta")}
          </a>
          <a
            href="#services"
          ...
          >
            ...
            {setting(settings, "heroSecondaryCta")}
          </a>
        </div>
